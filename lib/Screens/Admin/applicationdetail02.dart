...
class ApplicationDetail04 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Scholarship Application #$applicationNumber",
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [primaryTeal, const Color(0xFF20B2AA)],
  ...
  Widget _buildTile(String title, dynamic value) {
    return Container(
      ...
      child: Row(
        children: [
          Expanded(flex: 2, child: Text(title, style: const TextStyle(fontSize: 11, color: Colors.grey))),
