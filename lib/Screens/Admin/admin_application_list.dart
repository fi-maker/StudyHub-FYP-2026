...
class AdminApplicationList extends StatelessWidget {
  const AdminApplicationList({Key? key, required int applicationNumber, required Map<String, dynamic> applicationData}) : super(key: key);
