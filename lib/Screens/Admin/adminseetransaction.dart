...
class TransactionList extends StatelessWidget {
  ...
  Future<void> _updateTransactionStatus(String docId, String status) async {
                          ...
                          DataCell(
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: data['status'] == 'verified' ? Colors.green[100] :
                                (data['status'] == 'rejected' ? Colors.red[100] : Colors.orange[100]),
                                borderRadius: BorderRadius.circular(12),
                                border: Border.all(
                                  color: data['status'] == 'verified' ? Colors.green[200]! :
                                  (data['status'] == 'rejected' ? Colors.red[200]! : Colors.orange[200]!),
                                ),
                              ),
                              child: Text(
                                data['status']?.toUpperCase() ?? 'PENDING',
                                style: TextStyle(
                                  color: data['status'] == 'verified' ? Colors.green[800] :
                                  (data['status'] == 'rejected' ? Colors.red[800] : Colors.orange[800]),
                                  fontSize: 11,
                            ...
                            data['status'] == 'pending'
                              ...
                              children: [
                                Container(
                                  ...
                                  child: IconButton(
                                    icon: Icon(Icons.check, color: Colors.green[800], size: 16),
                                    onPressed: () => _updateTransactionStatus(doc.id, 'verified'),
                                ...
                                Container(
                                  ...
                                  child: IconButton(
                                    icon: Icon(Icons.close, color: Colors.red[800], size: 16),
                                    onPressed: () => _updateTransactionStatus(doc.id, 'rejected'),
                                    constraints: const BoxConstraints(),
                                    padding: const EdgeInsets.all(6),
                                  ),
                                ),
                              ...
                              decoration: BoxDecoration(
                                color: data['status'] == 'verified' ? Colors.green[50] : Colors.red[50],
                                borderRadius: BorderRadius.circular(12),
                              ),
                              child: Text(
                                data['status'] == 'verified' ? '✓ Done' : '✗ Rejected',
                                style: TextStyle(
                                  fontSize: 10,
                                  color: data['status'] == 'verified' ? Colors.green[800] : Colors.red[800],
